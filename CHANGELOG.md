...
- Browser OS now ships a galaxy wallpaper and advanced settings so users can set custom backgrounds with preferences saved in Supabase (2025-08-14 19:15:00 UTC)
- Browser OS desktop now supports drag-selection and inline folder renaming via double-click (2025-08-14 19:30:00 UTC)
### Changed
