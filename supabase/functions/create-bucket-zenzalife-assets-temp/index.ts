...
Deno.serve(async (req) => {
    ...
    const bucketConfig = {
        id: 'zenzalife-assets',
        name: 'zenzalife-assets',
        public: true
    };

    // Add optional configurations
    bucketConfig.allowed_mime_types = ["image/*", "audio/*"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for zenzalife-assets" ON storage.objects FOR SELECT USING (bucket_id = 'zenzalife-assets');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for zenzalife-assets" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'zenzalife-assets');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for zenzalife-assets" ON storage.objects FOR UPDATE USING (bucket_id = 'zenzalife-assets');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for zenzalife-assets" ON storage.objects FOR DELETE USING (bucket_id = 'zenzalife-assets');`
    ];
