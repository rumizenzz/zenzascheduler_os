...
### Fixed
- Constrained dashboard content width and hid horizontal overflow so modules no longer shift below the app or leave right-side whitespace (2025-08-03 00:19 UTC)
