...
- Improved calendar responsiveness and fixed duplicate event rendering.
- Prevented creation of tasks with the same title and start time.
- Fixed build failure by extending dayjs with the utc plugin.
