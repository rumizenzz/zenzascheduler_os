...
### Fixed
- Removed pull-to-refresh placeholder so dashboard tabs no longer start with extra white space (2025-08-03 16:38 UTC)
- Simplified dashboard scroll handling so section content no longer hides beneath a blank area (2025-08-03 16:05 UTC)
