...
- Stripped empty strings from garbage schedule data so Supabase UUID columns never receive invalid values (2025-08-01 16:32:00 UTC)
- Dropped empty fields before saving garbage schedules so new entries never trigger UUID syntax errors (2025-08-01 16:43:04 UTC)
