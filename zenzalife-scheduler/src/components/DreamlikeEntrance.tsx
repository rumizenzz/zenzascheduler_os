...
export function DreamlikeEntrance({ onComplete, children }: DreamlikeEntranceProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      {/* Swirling overlay */}
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-purple-50 via-blue-50 to-purple-100 opacity-15 blur-2xl animate-slow-swirl" />
